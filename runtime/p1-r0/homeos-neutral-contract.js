...
const definition = require('./residents/homeos-neutral');

const HOMEOS_NEUTRAL_RESIDENT_CONTRACT = Object.freeze({
  ...
  packagePolicyHash: PACKAGE_HASHES.HOMEOS_NEUTRAL,
  priorCheckpointRecovery: true,
  signalling: RESIDENT_SIGNALLING.FORBIDDEN,
  authorityMode: 'neutral'
});

module.exports = Object.freeze({ HOMEOS_NEUTRAL_RESIDENT_CONTRACT });
