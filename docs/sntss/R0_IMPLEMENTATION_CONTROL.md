...
| Laboratory core | `cores/sntss/v0.1.0/` | inert skeleton in R2; chemistry begins only in R3 |
...
| R3-R7 | chemistry, families, stimuli, receptors, lineage | R2 accepted | laboratory gates only | R3 numerical candidate; R4-R7 blocked |
