...
EXPECTED_WRAPPER_SHA256='d5c9ff9e1f6e1b1899f5f70ce6158127670afe2f2ac228fec87c7092df1d91c4'
...
staging="$(mktemp -d /run/stay-r124-metab-neutral-v1-bootstrap.XXXXXX)"
