...
EXPECTED_WRAPPER_SHA256='d343507dd3d4eb8af3bdc1d638c9346b532ca617e17780e33643039fa5119025'
...
staging="$(mktemp -d /run/stay-r127-metab-marker-recovery-v1-bootstrap.XXXXXX)"
...
echo 'R127_MARKER_RECOVERY_AUTHORIZED=NO'
