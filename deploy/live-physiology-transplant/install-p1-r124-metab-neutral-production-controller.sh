...
EXPECTED_WRAPPER_SHA256='835eba33068284ca0aeb5204e63312bbf0225722be1c3c3eb87fd114b86fa6a6'
...
staging="$(mktemp -d /run/stay-r127-metab-final-recovery-v1-bootstrap.XXXXXX)"
...
echo 'R127_FINAL_RECOVERY_AUTHORIZED=NO'
